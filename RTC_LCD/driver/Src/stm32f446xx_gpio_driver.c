 ...
 * @return            -
 *
 * @Note              - Check RCC Periph Rest Reg RCC_AHB1RSTR
 ...
 * @return            -
 *
 * @Note              - It is Processor Specific : Refer ARM Cortex M4 Generic User Guide
...
{
	//Clear EXTI_PR Register Corresponding to Pin Number
