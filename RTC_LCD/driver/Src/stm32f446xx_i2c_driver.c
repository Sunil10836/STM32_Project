 ...
 *
 * @brief             - This function enables or disables peripheral clock for the I2Cx
 *
 ...
 * @return            -
 *
 * @Note              - Check RCC Periph Reset Reg RCC_APB1RSTR
...
void I2C_EV_IRQHandling(I2C_Handle_t *pI2CHandle)
{
	...
	{
		//SB Flag is Set
		//This block is not executed in slave mode because in Slave mode SB is always zero
		//In this Lets Execute Address Phase
...
void I2C_IRQPriorityConfig(uint8_t IRQNumber, uint8_t IRQPriority)
{
	...
	uint8_t shift_amount = (8 * iprx_section) + (8 - NO_PR_BITS_IMPLMENTED);
...
void I2C_CloseSendData(I2C_Handle_t *pI2CHandle)
{
	...
	//Implement code to disable ITEVFEN Control bit
	pI2CHandle->pI2Cx->CR2 &= ~(1 << I2C_CR2_ITEVTEN);
